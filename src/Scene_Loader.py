...
class SceneLoader:
    ...
    def load_from_json(path: str, map_level: list, initial_zone: tuple, player, chase_sound, flee_sound) -> Scene:
        ...
        enemy_dict_placeholder = {
            (5, 2): [Stalker_Ghost(-200, -200, 100, StalkerBehaviour(player, speed=300, min_wait=15.0, max_wait=60.0, stop_distance=50, chase_sound=chase_sound, flee_sound=flee_sound))],
        }
