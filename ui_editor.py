...
class Ui_LevelEditor(object):
    def setupUi(self, LevelEditor):
        ...
        self.combo_map_select = CustomComboBox(self.group_tools)
        ...
        self.spin_grid_size = CustomSpinBox(self.group_tools)
        ...
        self.chk_layer_obstacles = QCheckBox("Obstáculos", self.group_layers)
        self.chk_layer_obstacles.setChecked(True)
        self.layout_layers.addWidget(self.chk_layer_obstacles)
        self.chk_layer_triggers = QCheckBox("Triggers", self.group_layers)
        self.chk_layer_triggers.setChecked(True)
        self.layout_layers.addWidget(self.chk_layer_triggers)
        self.chk_layer_interactables = QCheckBox("Interactables", self.group_layers)
        self.chk_layer_interactables.setChecked(True)
        self.layout_layers.addWidget(self.chk_layer_interactables)
        ...
        self.combo_zone_selector = CustomComboBox(self.groupBox)
        ...
        self.prop_type = CustomComboBox(self.properties_box)
        ...
        self.prop_x = CustomSpinBox(self.properties_box)
        ...
        self.prop_y = CustomSpinBox(self.properties_box)
        ...
        self.prop_image_path_combo = CustomComboBox(self.properties_box)
        ...
        self.prop_resize_factor = CustomDoubleSpinBox(self.properties_box)
        ...
        self.prop_hitbox_dx = CustomSpinBox(self.properties_box)
        ...
        self.prop_hitbox_dy = CustomSpinBox(self.properties_box)
        ...
        self.prop_hitbox_dw = CustomSpinBox(self.properties_box)
        ...
        self.prop_hitbox_dh = CustomSpinBox(self.properties_box)
        ...
        self.prop_z_index = CustomSpinBox(self.properties_box)
        ...
        self.lbl_sort_offset = QLabel(self.properties_box)
        self.lbl_sort_offset.setObjectName(u"label_offset_y")
        self.formLayout.setWidget(9, QFormLayout.LabelRole, self.lbl_sort_offset)
        self.prop_sort_offset = CustomSpinBox(self.properties_box)
        ...
        self.prop_width = CustomSpinBox(self.properties_box)
        self.prop_width.setMinimum(1)
        self.prop_width.setMaximum(9999)
        self.prop_width.setValue(50)
        self.prop_height = CustomSpinBox(self.properties_box)
        ...
        self.formLayout.setLayout(10, QFormLayout.FieldRole, self.layout_size)
        
        self.lbl_color = QLabel("Color (R, G, B):", self.properties_box)
        self.formLayout.setWidget(11, QFormLayout.LabelRole, self.lbl_color)
        self.layout_color = QHBoxLayout()
        self.prop_color_r = CustomSpinBox(self.properties_box)
        self.prop_color_r.setRange(0, 255)
        self.prop_color_g = CustomSpinBox(self.properties_box)
        self.prop_color_g.setRange(0, 255)
        self.prop_color_b = CustomSpinBox(self.properties_box)
        ...
        self.formLayout.setLayout(11, QFormLayout.FieldRole, self.layout_color)

        self.lbl_border = QLabel("Grosor Borde (0=Sólido):", self.properties_box)
        self.formLayout.setWidget(12, QFormLayout.LabelRole, self.lbl_border)
        self.prop_border_width = CustomSpinBox(self.properties_box)
        self.prop_border_width.setMinimum(0)
        self.prop_border_width.setMaximum(100)
        self.prop_border_width.setValue(0)
        self.formLayout.setWidget(12, QFormLayout.FieldRole, self.prop_border_width)

        self.label_mirror_y = QLabel("Reflejo Y (Mirror):", self.properties_box)
        self.formLayout.setWidget(13, QFormLayout.LabelRole, self.label_mirror_y)
        self.prop_reflection_offset = CustomSpinBox(self.properties_box)
        ...
        self.prop_anim_speed = CustomDoubleSpinBox(self.group_animation)
        ...
        self.lbl_auto_play = QLabel(self.group_animation)
        self.lbl_auto_play.setText("Auto-Play")
        self.horizontalLayout_10.addWidget(self.lbl_auto_play)
        self.chk_auto_play = QCheckBox(self.group_animation)
        self.chk_auto_play.setObjectName(u"chk_auto_play")
        ...
        self.prop_flash_image_path_combo = CustomComboBox()
        ...
        self.prop_used_image_path_combo = CustomComboBox()
        ...
        self.prop_interaction_duration = CustomSpinBox()
        ...
        self.prop_charge_sound_combo = CustomComboBox()
        ...
        # self.prop_step_action = CustomComboBox(self.group_step_detail)
    ...
    def retranslateUi(self, LevelEditor):
        ...
        self.lbl_sort_offset.setText(QCoreApplication.translate("LevelEditor", u"Y-Offset", None))
